...
Halide::Func merge(Halide::ImageParam imgs, Halide::ImageParam alignment, Halide::Expr minoffset, Halide::Expr maxoffset, Halide::Expr l1mindist, Halide::Expr l1maxdist);
