#ifndef HALIDE__mergstacka_h
#define HALIDE__mergstacka_h
#include <stdint.h>
...
int mergstacka(struct halide_buffer_t *_p1_buffer, struct halide_buffer_t *_p0_buffer, struct halide_buffer_t *_merge_spatial_output_buffer) HALIDE_FUNCTION_ATTRS;
int mergstacka_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mergstacka_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return mergstacka_metadata;
}
#endif


int mergstacka_old_buffer_t(struct buffer_t *_p1, struct buffer_t *_p0, struct buffer_t *_merge_spatial_output) HALIDE_FUNCTION_ATTRS;
