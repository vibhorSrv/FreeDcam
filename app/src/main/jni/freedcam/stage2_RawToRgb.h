#ifndef HALIDE__stage2_RawToRgb_h
#define HALIDE__stage2_RawToRgb_h
#include <stdint.h>
...
int stage2_RawToRgb(struct halide_buffer_t *_p2_buffer, int32_t _p3, int32_t _p4, float _p5, float _p6, float _p7, float _p8, float _p9, float _p10, struct halide_buffer_t *_8bit_interleaved_output_buffer) HALIDE_FUNCTION_ATTRS;
int stage2_RawToRgb_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *stage2_RawToRgb_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return stage2_RawToRgb_metadata;
}
#endif


int stage2_RawToRgb_old_buffer_t(struct buffer_t *_p2, int32_t _p3, int32_t _p4, float _p5, float _p6, float _p7, float _p8, float _p9, float _p10, struct buffer_t *_8bit_interleaved_output) HALIDE_FUNCTION_ATTRS;
